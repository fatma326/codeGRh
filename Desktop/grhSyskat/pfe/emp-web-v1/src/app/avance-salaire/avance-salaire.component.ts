...
import {EditAvanceSalaireComponent} from './edit-avance-salaire/edit-avance-salaire.component';
...
export class AvanceSalaireComponent implements OnInit {
  ...
  post() {
    this.httpClient.post(this.url, this.item)
      .subscribe(data => {
        //this.employer = data;
        console.log("avance a ete ajoute !!")
        this.submitted = true;
  ...
  ajouter(){
    ...
    const dialogRef = this.dialog.open(EditAvanceSalaireComponent, {
      data: {
        item: this.item,
        btn: 'Ajouter'
      }
  ...
  delete() {
    this.httpClient.delete(this.url + '/'+this.item.idAvance)
      .subscribe(data => {
        //this.employer = data;
        console.log("avance  a ete supprimer !!")
        this.submitted = true;
        this.mode = 'supprimer'
        this.refreshDataGrid();
      }, err => {
